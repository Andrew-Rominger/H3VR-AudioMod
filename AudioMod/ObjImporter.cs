...
namespace AudioMod
{
    public sealed class FastObjImporter
    {
        ...
        public Mesh ImportFile(string path)
        {
            return ImportObj(File.ReadAllText(path));
        }
        // Use this for initialization
        public Mesh ImportObj(string objContent)
        {
        ...
        private void LoadMeshData(string objContent)
        {
            StringBuilder sb = new StringBuilder();
            string text = objContent;
            int start = 0;
